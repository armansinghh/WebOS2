...
export default function GamesApp() {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-white select-none" style={{ fontFamily: '"Segoe UI", Tahoma, sans-serif' }}>
      ...
      <div className="flex flex-col p-2 gap-2 border-b border-[#a0a0a0] z-10" style={{ background: 'linear-gradient(180deg, #ffffff 0%, #e5ebf2 49%, #d4e0eb 50%, #eef3f7 100%)', boxShadow: 'inset 0 1px 0 #ffffff' }}>
        <div className="flex items-center gap-2">
                ...
                {filteredGames.map((game) => {
                  ...
                  return (
                    <div 
                      ...
                      className={`flex flex-col items-center gap-2 p-2 rounded-xs cursor-pointer border ${
                        isSelected 
