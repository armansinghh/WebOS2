...
export default function CalendarFlyout({ isOpen, onClose }) {
    ...
    days.push(
      <div
        ...
        className={`flex items-center justify-center cursor-default
          ${isToday
            ? 'bg-[#cce8ff] border border-[#99d1ff] text-black font-semibold'
  ...
  return (
    <FlyoutShell className="absolute right-2 top-9 z-50" style={{ width: '230px' }}>
      {/* Month Header */}
      <div
      ...
      <div className="py-2 px-3 text-center text-gray-600 border-t border-[#d4d4d4]" style={{ fontSize: '11px', background: '#f0f0f0' }}>
